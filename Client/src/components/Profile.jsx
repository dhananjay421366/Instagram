...
//     return (
//         <>
//             <div className="flex max-w-8xl justify-center mx-8 pl-16">
...
//                                 <div className="flex gap-2 items-center">  <span>{userProfile.username}</span>
//                                     {
//                                         isLoggedInUserProfile ? (<> <Link to={'/account/edit'}><Button variant="secondary" className="bg-gray-200 h-8 ">Edit profile</Button></Link>
//                                             <Button variant="secondary" className="bg-gray-200 h-8 ">view archive</Button>
//                                             <Button variant="secondary" className="bg-gray-200 h-8 ">Add tools</Button>
//                                         </>
//                                         ) : (
//                                             isFollowing ? <><Button variant="secondary" className=" h-8 ">Unfollow</Button>

//                                                 <Button variant="secondary" className=" h-8 ">Message</Button></> : <Button className="bg-[#0095F6]  hover:bg-[#1e85ca] h-8 ">Follow</Button>
//                                         )
//                                     }
//                                 </div>
...
//                                     return <div className='relative group p-2 cursor-pointer' key={post._id}>
//                                         <img className='rounded-sm my-2 w-[300px] aspect-square object-cover' src={post.image} alt="post_image" />
                ...
                {isLoggedInUserProfile ? (
                  <div className="flex gap-2">
                    <Link to={'/account/edit'}>
                      <Button variant="secondary" className="bg-gray-200 h-8">Edit profile</Button>
                    </Link>
                    <Button variant="secondary" className="bg-gray-200 h-8">View Archive</Button>
                    <Button variant="secondary" className="bg-gray-200 h-8">Add Tools</Button>
                  </div>
                  ...
                  isFollowing ? (
                    ...
                    <Button className="bg-[#0095F6] hover:bg-[#1e85ca] h-8">Follow</Button>
                  )
                )}
              </div>
              {/* Profile Stats */}
